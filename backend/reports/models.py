...
class StatementOfCourtFeesFines(models.Model):
    report_year = models.IntegerField()
    report_month=models.CharField(max_length=100)
    court_fees_collected=models.DecimalField(max_digits=12, decimal_places=2, null=True)
    fines_collected=models.DecimalField(max_digits=12, decimal_places=2, null=True)
    misc_collected=models.DecimalField(max_digits=12, decimal_places=2, null=True)
