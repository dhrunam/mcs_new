...
class ExParteInjunctionCasesReportList(generics.ListCreateAPIView):
    queryset = report_models.ExParteInjunctionCasesReport.objects.all().order_by('-id')
    serializer_class = report_serializer.ExParteInjunctionCasesReportSerializer 
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            model =report_models.ExParteInjunctionCasesReport
            records = []
            ...
            report_models.ExParteInjunctionCasesReport.objects.bulk_create(records)
...
class ExParteInjunctionCasesReportListGetForHCS(generics.ListAPIView):
    queryset = report_models.ExParteInjunctionCasesReport.objects.all().order_by('-id')
    serializer_class = report_serializer.ExParteInjunctionCasesReportSerializer 
...
class LastUploadedExParteInjunctionCasesReportList(generics.ListAPIView):
    queryset = report_models.ExParteInjunctionCasesReport.objects.all().order_by('-id')
    serializer_class = report_serializer.ExParteInjunctionCasesReportSerializer 
