...
class PendingCasesReportList(generics.ListCreateAPIView):
    queryset = report_models.PendingCasesReport.objects.all().order_by('-id')
    serializer_class = report_serializer.PendingCasesReportSerializer
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            model =report_models.PendingCasesReport
            ...
            report_models.PendingCasesReport.objects.bulk_create(records)
...
class PendingCasesReportListGetForHCS(generics.ListAPIView):
    queryset = report_models.PendingCasesReport.objects.all().order_by('-id')
    serializer_class = report_serializer.PendingCasesReportSerializer
...
class LastUploadedPendingCasesReportList(generics.ListAPIView):
    queryset = report_models.PendingCasesReport.objects.all().order_by('-id')
    serializer_class = report_serializer.PendingCasesReportSerializer
