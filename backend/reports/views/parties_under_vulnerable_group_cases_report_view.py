...
class PartiesUnderVulnerableGroupCasesReportList(generics.ListCreateAPIView):
    queryset = report_models.PartiesUnderVulnerableGroupCasesReport.objects.all().order_by('-id')
    serializer_class = report_serializer.PartiesUnderVulnerableCasesReportSerializer
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            model =report_models.PartiesUnderVulnerableGroupCasesReport
            records = []
            ...
            report_models.PartiesUnderVulnerableGroupCasesReport.objects.bulk_create(records)
...
class PartiesUnderVulnerableGroupCasesReportListGetForHCS(generics.ListAPIView):
    queryset = report_models.PartiesUnderVulnerableGroupCasesReport.objects.all().order_by('-id')
    serializer_class = report_serializer.PartiesUnderVulnerableCasesReportSerializer
...
class LastUploadedPartiesUnderVulnerableGroupCasesReportList(generics.ListAPIView):
    queryset = report_models.PartiesUnderVulnerableGroupCasesReport.objects.all().order_by('-id')
    serializer_class = report_serializer.PartiesUnderVulnerableCasesReportSerializer
