...
class PendingCasesPartiesAboveSixtyList(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        try:
            ...
            model =report_models.PendingCasesPartiesAboveSixty
            records = []
            ...
            report_models.PendingCasesPartiesAboveSixty.objects.bulk_create(records)
...
class PendingCasesPartiesAboveSixtyListGetForHCS(generics.ListAPIView):
    queryset = report_models.PendingCasesPartiesAboveSixty.objects.all().order_by('-id')
    serializer_class = report_serializer.PendingCasesPartiesAboveSixtySerializer
...
class LastUploadedPendingCasesPartiesAboveSixtyList(generics.ListAPIView):
    queryset = report_models.PendingCasesPartiesAboveSixty.objects.all().order_by('-id')
    serializer_class = report_serializer.PendingCasesPartiesAboveSixtySerializer
